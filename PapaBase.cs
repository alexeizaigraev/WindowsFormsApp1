...
namespace WindowsFormsApp1
{
    partial class Papa
    {
        internal static string partnerCoised;
        ...
        protected static Dictionary<string, string> FileToDict(int colNum)
        {
            ...
            foreach (string[] line in data)
            {
                try
                {
                    d[line[0]] = line[colNum];
                }
                catch
                {
                    Sos("Err FileToDict", line[0]);
                }
            }
        ...
        protected static List<string> DictToList(Dictionary<string, string> dict)
        {
        ...
        protected static List<string> DictToHead(Dictionary<string, string> dict)
        {
            List<string> rez = new List<string>();
        ...
        protected static Dictionary<string, Dictionary<string, string>> FileToHashTab(string fName, int keyColNum)
        {
            ...
            try
            {
                hashTab = ArrToHash(head, list, keyColNum);
            }
            catch
            {
        ...
        protected static List<string[]> SubList(List<string[]> list, int start, int finish)
        {
            ...
            for (int i = start; i <= finish; i++)
            {
                ...
                {
                    Sos("Err Sublist", String.Format(" row {0}", i));
                }
            }
            return myList;
        }
        ...
        protected static string DataPath()
        {
            ...
            try
            {
                path = File.ReadAllLines(Path.Combine("Config", "ConfigDataPath.txt"))[0];
            }
            catch
            {
                Sos("Err read DataPath", Path.Combine("Config", "ConfigDataPath.txt"));
            }
        ...
        protected static Dictionary<string, string> MkComonHash(int keyColNum)
        {
            ...
            try
            {
                data = FileToArr(myDataPath);
            }
            catch
            {
                Sos("Err read", myDataPath);
            }
            ...
            {
                Sos("Err MkComonHash", String.Format("KeyColNum {0}", keyColNum));
            }
            return rez;
        }
